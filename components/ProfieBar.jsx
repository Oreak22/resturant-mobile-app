...
import { setHistory } from "../redux/golbalReducer";
...
const ProfieBar = ({ title }) => {
	...
	const setIt = async () => {
		...
		dispatch(setHistory(thisUser[0].history));
	};
	useEffect(() => {
		setIt();
	}, []);
	...
	return (
		<>
					...
					<View style={styles.ModalContent}>
						<View style={styles.ModalHeader}>
							...
							<View>
								...
								<Text style={{ fontSize: 16, color: "gray" }}>{useremail}</Text>
							</View>
						</View>
			...
			<Modal
				...
				transparent={false}
				animationType='slide'
				onRequestClose={() => setCart1(false)}
			>
				<View>
					<Cart setCart={setCart1} />
				</View>
			</Modal>
		</>
	);
